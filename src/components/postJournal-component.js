...
const PostJournalComponent = (props) => {
  ...
  // };
  const postJournal = () => {
    JournalService.post(title, description)
      .then(() => {
    ...
    <div style={{ padding: "3rem" }}>
      ...
      {currentUser && currentUser.user.role == "admin" && (
        <div className="form-group">
          ...
          />
          <br /> */}
          <button className="btn btn-primary" onClick={postJournal}>
            Submit
          </button>
          <br />
          <br />
...
export default PostJournalComponent;
